...
<motion.div
      ...
      className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800/50 hover:shadow-md transition-shadow"
    >
      <div className="flex flex-col">
        ...
        <Typography variant="caption" className="text-gray-500 italic mt-1">{analysis.repository}</Typography>
